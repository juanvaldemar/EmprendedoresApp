...
//         });
// });
// exports.sendNewHistoryNotification = functions.database.ref('/Proyectos/{newId}')
...
//         const notification = {
//             title: `${nombre} ha agregado una historia.`,
//             body: `Dale un vistazo a ${nombre}`,
//             sound: 'default'
//         }
...
//         return admin.messaging().sendToTopic("Proyectos", payload, options)
//             .then((response) => {
