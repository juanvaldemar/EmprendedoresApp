...
public class RegistrarFragment extends Fragment {
    ...
    private EditText edt_nombres_emprendedor, edt_apellidos_emprendedor,
            ...
            edt_facebook, edt_instagram, edt_twitter,edt_a_que_te_dedicas_emprendedor, edt_fecha_nac;
    ...
    private String mAnioNacimiento;
    private String mMesNacimiento;
    private String mDiaNacimiento;
    ...
    private void initView(View root) {
        ...
        edt_fecha_nac = root.findViewById(R.id.edt_fecha_nac);
        ...
        edt_fecha_nac.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showDatePickerDialog() {
        DatePickerFragment newFragment = DatePickerFragment.newInstance(new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                mDiaNacimiento = formatoDosDigitosFecha(day);
                mMesNacimiento = formatoDosDigitosFecha(month+1);
                mAnioNacimiento = formatoDosDigitosFecha(year);
                // +1 because January is zero
                final String selectedDate = mDiaNacimiento + " / " + mMesNacimiento + " / " + mAnioNacimiento;
                edt_fecha_nac.setText(selectedDate);
            }
        });
    ...
    private String formatoDosDigitosFecha(int n) {
    ...
    private void cargarEmprendedor() {
        ...
        edt_fecha_nac.setText(mEmprendedor.getSpinner_dia() + "/" + mEmprendedor.getSpinner_mes() + "/" + mEmprendedor.getSpinner_anio());
                            ...
                            public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        newPost.child("spinner_dia").setValue(mDiaNacimiento);
                                        newPost.child("spinner_mes").setValue(mMesNacimiento);
                                        newPost.child("spinner_anio").setValue(mAnioNacimiento);
    ...
    private boolean validarCampos() {
       items = new ArrayList<String>();
        ...
        if (!(validarEditText(edt_nombres_emprendedor)
                ...
                && edt_fecha_nac.getText().toString().contains("/")
